    ...
    <div>
      ...
      >
        <motion.div
          ...
          className="mt-12 flex flex-col w-full lg:flex-row font-[Outfit] items-center shadow-lg"
        >
          ...
          <ScrollLink
            className="border border-alt px-8 py-2 flex justify-center rounded-bl-md lg:rounded-bl-none lg:rounded-tr-md rounded-br-md cursor-pointer w-full hover:bg-alt hover:text-black transition-all"
            to="contact"
            spy={true}
            smooth={true}
            offset={-125}
